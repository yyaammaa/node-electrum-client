...
class ElectrumClient extends Client{
    ...
    blockchainScriptHash_getBalance(address){
        return this.request('blockchain.scripthash.get_balance', [address])
    }
    blockchainScriptHash_getHistory(address){
        return this.request('blockchain.scripthash.get_history', [address])
    }
    blockchainScriptHash_listunspent(address){
